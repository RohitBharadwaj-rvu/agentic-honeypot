...
**message (Required)** - The latest incoming message in the conversation.
| Field | Description |
|-------|-------------|
...
**conversationHistory (Optional)** - All previous messages in the same conversation.
...
> ⚠️ **This is mandatory for evaluation.**
